...
class GptController extends Controller
{
    ...
    public function generatePost(Request $request){
        ...
        $anchor_3=null;
        $id_content=null;
        $token='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';


        foreach(Wp_post_content::where('id',$request->id) as $post_config){
