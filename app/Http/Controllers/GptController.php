...
class GptController extends Controller
{
    ...
    public function gptThread($id,$post_title){
        ...
        $Google_api_key = isset(Drive_credential::all()->first()->api_key) ? Drive_credential::all()->first()->api_key : false;
